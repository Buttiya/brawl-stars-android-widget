...
## Источники данных
### API
- Приложение использует внешний API для получения данных профиля, ротации событий, режимов и предиктов.
- Текущий backend развернут на Railway.

Используемый base URL:

```properties
BRAWL_API_BASE_URL=https://local-server-production-0c63.up.railway.app/
```
...
## Локальная сборка
```powershell
$env:JAVA_HOME="C:\Codex\brawl-stars-android-widget\jdk-17.0.11+9"
